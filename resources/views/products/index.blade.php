    ...
    <div class="col-md-12 table-responsive">
        <table class="table table-hover table-bordered align-middle text-center rounded-3">
            ...
            <tbody>
                ...
                <tr class="{{ ($product->product_status and $product->product_status->value === \App\Enums\Product\ProductStatus::DEACTIVE->value) ? 'table-danger' : '' }}">
                    <td>
                    ...
                    <td>
                        <a class="btn btn-light border border-dark w-100" href="{{ route('products.product_properties.create', ['product_id' => $product->id]) }}">
                            @lang('Properties')
                        </a>
                    </td>
                    <td>
                        <a class="btn btn-light border border-dark w-100" href="{{ route('products.product_tags.create', ['product_id' => $product->id]) }}">
                            @lang('Tags')
                        </a>
                    </td>
                    <td>
                        <a class="btn btn-light border border-dark w-100" href="{{ route('products.product_images.index', ['product_id' => $product->id]) }}">
                            @lang('product_images')
                        </a>
                    </td>
                    <td>
